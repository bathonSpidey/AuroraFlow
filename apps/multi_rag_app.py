...
class App(Tk):
    ...
    def add_load_pdf_button(self):
        self.load_pdf_button = Button(self, text="Open Folder", command=self.get_pdf)
    ...
    def get_pdf(self):
        self.my_file = filedialog.askdirectory()
        if self.my_file:
    ...
    def search(self):
        ...
        if self.my_file == "":
            ...
            if self.search_entry.get() == "":
                ...
                return
            self.rag = MultiAuroraRag(self.my_file, "all-mpnet-base-v2")
